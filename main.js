...
module.exports = "<main>\n  <div class=\"row\">\n    <article class=\"one-half column\">\n        <h2>Welcome to dojo.shrub!</h2>\n      <p>\n        Hi! My name is Alan. For the past few years I've been involved with the Coding Dojo Community as a student, TA, Online Instructor and Onsite Instructor. This is a place where I share some helpful things for people that are varying stages of their dojo adventure. While this site is perhaps most geared towards those that are currenty students at Coding Dojo Seattle, it has a little bit for those that are starting their journeys or looking post-dojo as well. It is not an official site and isn't for admissions information, go to the coding dojo website, but is a motley collection of helpful dojo things.\n      </p>\n      <p>Alan</p>\n    </article>\n    <ul class=\"one-half column\">\n    <li [ngClass]=\"amIInfo('calendars')\" (click)=\"setInfo('calendars')\">\n      <h3 class=\"button whole column\">Calendars</h3>\n      <div>\n        <p>{{ calendarText }}</p>\n      </div>\n    </li>\n    <li [ngClass]=\"amIInfo('lists')\" (click)=\"setInfo('lists')\">\n      <h3 class=\"button whole column\">Resources</h3>\n      <div>\n        <p>{{ resourcesText }}</p>\n      </div>\n    </li>\n    <li [ngClass]=\"amIInfo('olio')\" (click)=\"setInfo('olio')\">\n      <h3 class=\"button whole column\">Olio</h3>\n      <div>\n        <p>{{ olioText }}</p>\n      </div>\n    </li>\n  </ul>\n</div>\n</main>"
